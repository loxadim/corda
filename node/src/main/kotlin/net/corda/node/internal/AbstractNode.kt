...
abstract class AbstractNode(open val configuration: NodeConfiguration,
    ...
    open protected fun makeNotaryService(type: ServiceType, tokenizableServices: MutableList<Any>): NotaryService {
        ...
        return when (type) {
            ...
            BFTValidatingNotaryService.type -> with(configuration as FullNodeConfiguration) {
                ...
                BFTValidatingNotaryService(services, timestampChecker, notaryNodeAddress!!, notaryClusterAddresses, database, client)
            }
            else -> {
